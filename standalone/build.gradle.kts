...
tasks {
    ...
    register<JavaExec>("runHelloAll") {
        ...
        project.logger.lifecycle("   Visit http://localhost:8080/notification?account=test")
    ...
    register<JavaExec>("runHelloWorkflow") {
        ...
        project.logger.lifecycle("")
        project.logger.lifecycle("================================================================================")
        project.logger.lifecycle(" To try this example, visit http://localhost:8080/notification?account=test")
        project.logger.lifecycle(" also initiate a payment http://localhost:8080/payment?account=test")
        project.logger.lifecycle(" and confirm it http://localhost:8080/confirm?account=test")
        project.logger.lifecycle("================================================================================")
        project.logger.lifecycle("")
