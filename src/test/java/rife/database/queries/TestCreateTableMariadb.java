...
public class TestCreateTableMariadb extends TestCreateTable {
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testInstantiationMariadb() {
        var query = new CreateTable(MARIADB);
        try {
            query.getSql();
            fail();
    ...
    void testColumnMariadb() {
        ...
        // this is invalid to execute with Mariadb
        // VARCHAR and CHAR need size specification
    }

    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testColumnPrecisionMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename1")
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testColumnsBeanIncludedMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testColumnsBeanExcludedMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testColumnsBeanFilteredMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testColumnsBeanPrecisionMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .columns(BeanImpl.class)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testColumnsBeanConstrainedMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testDefaultFunctionMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename1")
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testCustomAttributeMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename1")
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testPrimaryKeySimpleMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
            .primaryKey("intColumn");
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testPrimaryKeyMultipleMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testPrimaryKeyNamedMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testPrimaryKeyMultipleNamedMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
            .column("stringColumn", String.class, 50)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testUniqueMultipleMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
            .column("stringColumn", String.class, 50)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testUniqueMultipleNamedMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
            .column("stringColumn", String.class, 50)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testForeignKeySimpleMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testForeignKeyMultipleMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
            .column("stringColumn", String.class, 50)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testForeignKeySimpleNamedMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testForeignKeyMultipleNamedMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
            .column("stringColumn", String.class, 50)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testForeignKeyViolationsSingleMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testForeignKeyViolationsMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
    ...
    @DatasourceEnabledIf(TestDatasourceIdentifier.MARIADB)
    void testForeignKeyMultipleViolationsMariadb() {
        var query = new CreateTable(MARIADB);
        query.table("tablename")
            .column("intColumn", int.class)
            .column("stringColumn", String.class, 50)
...
//        CreateTable query = new CreateTable(MARIADB);
//        query.table("tablename")
//            .columns(BeanImpl.class)
//            .precision("propertyBigDecimal", 19, 9)
//            .precision("propertyBoolean", 4)
