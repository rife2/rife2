    ...
    throws IOException {
        try (final var server = new TestServerRunner(new RoutingGetSite())) {
            try (final var webClient = new WebClient()) {
                ...
                assertEquals("class GetElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetElement"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class GetPathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetPathInfoElement/pathinfo"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class GetElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get3"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class GetPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get4/otherpathinfo"), HttpMethod.GET)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetElement"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetPathInfoElement/pathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get3"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get4/otherpathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetElement"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetPathInfoElement/pathinfo"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get3"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get4/otherpathinfo"), HttpMethod.POST)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetElement"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetPathInfoElement/pathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get3"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get4/otherpathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetElement"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetPathInfoElement/pathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get3"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get4/otherpathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                ...
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetElement"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetPathInfoElement/pathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get3"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get4/otherpathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetElement"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetPathInfoElement/pathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get3"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get4/otherpathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetElement"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetSite_GetPathInfoElement/pathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get3"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/get4/otherpathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
            }
        }
    }
    ...
    throws IOException {
        try (final var server = new TestServerRunner(new RoutingPostSite())) {
            try (final var webClient = new WebClient()) {
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostElement"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostPathInfoElement/pathinfo"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post3"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post4/otherpathinfo"), HttpMethod.GET)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostElement"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostPathInfoElement/pathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post3"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post4/otherpathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                ...
                assertEquals("class PostElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostElement"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class PostPathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostPathInfoElement/pathinfo"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class PostElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post3"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class PostPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post4/otherpathinfo"), HttpMethod.POST)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostElement"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostPathInfoElement/pathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post3"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post4/otherpathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostElement"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostPathInfoElement/pathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post3"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post4/otherpathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                ...
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostElement"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostPathInfoElement/pathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post3"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post4/otherpathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostElement"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostPathInfoElement/pathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post3"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post4/otherpathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostElement"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPostSite_PostPathInfoElement/pathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post3"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/post4/otherpathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
            }
        }
    }
    ...
    throws IOException {
        try (final var server = new TestServerRunner(new RoutingGetPostSite())) {
            try (final var webClient = new WebClient()) {
                ...
                assertEquals("class GetPostElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostElement"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class GetPostPathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostPathInfoElement/pathinfo"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class GetPostElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost3"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class GetPostPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost4/otherpathinfo"), HttpMethod.GET)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostElement"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostPathInfoElement/pathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost3"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost4/otherpathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                ...
                assertEquals("class GetPostElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostElement"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class GetPostPathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostPathInfoElement/pathinfo"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class GetPostElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost3"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class GetPostPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost4/otherpathinfo"), HttpMethod.POST)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostElement"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostPathInfoElement/pathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost3"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost4/otherpathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostElement"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostPathInfoElement/pathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost3"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost4/otherpathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                ...
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostElement"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostPathInfoElement/pathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost3"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost4/otherpathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostElement"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostPathInfoElement/pathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost3"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost4/otherpathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostElement"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingGetPostSite_GetPostPathInfoElement/pathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost3"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/getPost4/otherpathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
            }
        }
    }
    ...
    throws IOException {
        try (final var server = new TestServerRunner(new RoutingPutSite())) {
            try (final var webClient = new WebClient()) {
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutElement"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutPathInfoElement/pathinfo"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put3"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put4/otherpathinfo"), HttpMethod.GET)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutElement"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutPathInfoElement/pathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put3"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put4/otherpathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutElement"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutPathInfoElement/pathinfo"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put3"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put4/otherpathinfo"), HttpMethod.POST)).getWebResponse().getStatusCode());
                ...
                assertEquals("class PutElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutElement"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                assertEquals("class PutPathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutPathInfoElement/pathinfo"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                assertEquals("class PutElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put3"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                assertEquals("class PutPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put4/otherpathinfo"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutElement"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutPathInfoElement/pathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put3"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put4/otherpathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                ...
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutElement"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutPathInfoElement/pathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put3"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put4/otherpathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutElement"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutPathInfoElement/pathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put3"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put4/otherpathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutElement"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPutSite_PutPathInfoElement/pathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put3"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/put4/otherpathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
            }
        }
    }
    ...
    throws IOException {
        try (final var server = new TestServerRunner(new RoutingDeleteSite())) {
            try (final var webClient = new WebClient()) {
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeleteElement"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeletePathInfoElement/pathinfo"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete3"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete4/otherpathinfo"), HttpMethod.GET)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeleteElement"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeletePathInfoElement/pathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete3"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete4/otherpathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeleteElement"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeletePathInfoElement/pathinfo"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete3"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete4/otherpathinfo"), HttpMethod.POST)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeleteElement"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeletePathInfoElement/pathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete3"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete4/otherpathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                ...
                assertEquals("class DeleteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeleteElement"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                assertEquals("class DeletePathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeletePathInfoElement/pathinfo"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                assertEquals("class DeleteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete3"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                assertEquals("class DeletePathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete4/otherpathinfo"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                ...
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeleteElement"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeletePathInfoElement/pathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete3"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete4/otherpathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeleteElement"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeletePathInfoElement/pathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete3"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete4/otherpathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeleteElement"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingDeleteSite_DeletePathInfoElement/pathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete3"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/delete4/otherpathinfo"), HttpMethod.PATCH)).getWebResponse().getStatusCode());
            }
        }
    }
    ...
    throws IOException {
        try (final var server = new TestServerRunner(new RoutingPatchSite())) {
            try (final var webClient = new WebClient()) {
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchElement"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchPathInfoElement/pathinfo"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch3"), HttpMethod.GET)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch4/otherpathinfo"), HttpMethod.GET)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchElement"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchPathInfoElement/pathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch3"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch4/otherpathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchElement"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchPathInfoElement/pathinfo"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch3"), HttpMethod.POST)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch4/otherpathinfo"), HttpMethod.POST)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchElement"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchPathInfoElement/pathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch3"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch4/otherpathinfo"), HttpMethod.PUT)).getWebResponse().getStatusCode());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchElement"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchPathInfoElement/pathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch3"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch4/otherpathinfo"), HttpMethod.DELETE)).getWebResponse().getStatusCode());
                ...
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchElement"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchPathInfoElement/pathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch3"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch4/otherpathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchElement"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchPathInfoElement/pathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch3"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch4/otherpathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                ...
                assertEquals("class PatchElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchElement"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
                assertEquals("class PatchPathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingPatchSite_PatchPathInfoElement/pathinfo"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
                assertEquals("class PatchElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch3"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
                assertEquals("class PatchPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/patch4/otherpathinfo"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
            }
        }
    }
    ...
    throws IOException {
        try (final var server = new TestServerRunner(new RoutingRouteSite())) {
            try (final var webClient = new WebClient()) {
                ...
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RouteElement"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RoutePathInfoElement/pathinfo"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route3"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route4/otherpathinfo"), HttpMethod.GET)).getWebResponse().getContentAsString());
                ...
                assertEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RouteElement"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RoutePathInfoElement/pathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route3"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route4/otherpathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                ...
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RouteElement"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RoutePathInfoElement/pathinfo"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route3"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route4/otherpathinfo"), HttpMethod.POST)).getWebResponse().getContentAsString());
                ...
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RouteElement"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RoutePathInfoElement/pathinfo"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route3"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route4/otherpathinfo"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                ...
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RouteElement"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RoutePathInfoElement/pathinfo"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route3"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route4/otherpathinfo"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                ...
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RouteElement"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RoutePathInfoElement/pathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route3"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route4/otherpathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                ...
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RouteElement"), HttpMethod.TRACE)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RoutePathInfoElement/pathinfo"), HttpMethod.TRACE)).getWebResponse().getContentAsString());
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route3"), HttpMethod.TRACE)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route4/otherpathinfo"), HttpMethod.TRACE)).getWebResponse().getContentAsString());
                ...
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RouteElement"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:pathinfo",       webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/routingRouteSite_RoutePathInfoElement/pathinfo"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
                assertEquals("class RouteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route3"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
                assertEquals("class RoutePathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/supplier/route4/otherpathinfo"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
            }
        }
    }
    ...
    throws IOException {
        try (final var server = new TestServerRunner(new RoutingComboSite())) {
            try (final var webClient = new WebClient()) {
                ...
                assertEquals("class GetElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo5"), HttpMethod.GET)).getWebResponse().getContentAsString());
                assertEquals("class GetPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo6/otherpathinfo"), HttpMethod.GET)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo5"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo6/otherpathinfo"), HttpMethod.HEAD)).getWebResponse().getStatusCode());
                ...
                assertEquals("class PostElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo5"), HttpMethod.POST)).getWebResponse().getContentAsString());
                assertEquals("class PostPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo6/otherpathinfo"), HttpMethod.POST)).getWebResponse().getContentAsString());
                ...
                assertEquals("class PutElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo5"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                assertEquals("class PutPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo6/otherpathinfo"), HttpMethod.PUT)).getWebResponse().getContentAsString());
                ...
                assertEquals("class DeleteElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo5"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                assertEquals("class DeletePathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo6/otherpathinfo"), HttpMethod.DELETE)).getWebResponse().getContentAsString());
                ...
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo5"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                assertEquals("", webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo6/otherpathinfo"), HttpMethod.OPTIONS)).getWebResponse().getContentAsString());
                ...
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo5"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                assertNotEquals(200, webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo6/otherpathinfo"), HttpMethod.TRACE)).getWebResponse().getStatusCode());
                ...
                assertEquals("class PatchElement",                        webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo5"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
                assertEquals("class PatchPathInfoElement:otherpathinfo",  webClient.getPage(new WebRequest(new URL("http://localhost:8181/combo6/otherpathinfo"), HttpMethod.PATCH)).getWebResponse().getContentAsString());
            }
        }
    }
}
