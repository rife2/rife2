...
public class generic extends DatabaseUsers {
    ...
    protected CreateTable createTableUser_;
    protected CreateTable createTableRoleLink_;
    protected Select verifyCredentialsNoRole_;
    protected Select verifyCredentialsRole_;
    protected Select getRoleId_;
    protected SequenceValue getNewRoleId_;
    protected Insert addRole_;
    protected Select containsRole_;
    protected Select countRoles_;
    protected Select listRoles_;
    protected Insert addUserWithId_;
    protected Select getFreeUserId_;
    protected Insert addRoleLink_;
    protected Select getAttributes_;
    protected Select getUserRoles_;
    protected Select containsUser_;
    ...
    protected Select listUsersInRole_;
    protected Update updateUser_;
    protected Delete removeRoleLinksByUserId_;
    protected Delete removeUserByLogin_;
    protected Delete removeUserByUserId_;
    protected Delete removeRole_;
    protected Delete clearUsers_;
    protected Select listUserRoles_;
    protected DropSequence dropSequenceRole_;
    protected DropTable dropTableRole_;
    protected DropTable dropTableUser_;
    protected DropTable dropTableRoleLink_;
