...
public class generic extends DatabaseContent {
    protected final CreateSequence createSequenceContentRepository_;
    protected final CreateSequence createSequenceContentInfo_;
    ...
    protected final String createContentInfoPathIndex_;
    protected String createContentInfoPathNameIndex_;
    protected final DropSequence dropSequenceContentRepository_;
    protected final DropSequence dropSequenceContentInfo_;
    protected final DropTable dropTableContentRepository_;
    protected final DropTable dropTableContentInfo_;
    protected final DropTable dropTableContentAttribute_;
    protected final DropTable dropTableContentProperties_;
    protected String dropContentInfoPathIndex_;
    protected String dropContentInfoPathNameIndex_;
    protected final SequenceValue getNewContentRepositoryId_;
    protected final SequenceValue getNewContentId_;
    protected final Select getContentRepositoryId_;
    protected final Select getContentInfo_;
    protected Select getVersion_;
    protected Insert storeContentRepository_;
    protected final Select containsContentRepository_;
    protected Insert storeContentInfo_;
    protected final Insert storeContentAttribute_;
    protected final Insert storeContentProperty_;
    protected final Delete deleteContentInfo_;
    protected final Delete deleteContentAttributes_;
    protected final Delete deleteContentProperties_;
    protected Select getLatestContentInfo_;
    protected final Select getContentAttributes_;
    protected final Select getContentProperties_;
