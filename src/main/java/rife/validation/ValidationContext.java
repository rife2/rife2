 ...
 * in which {@code Validated} bean instances can be validated.
 *
...
public interface ValidationContext {
    /**
     * Validates a {@code Validated} in this context.
     ...
     *
     * @param validated the {@code Validated} instance that will be validated
     * @since 1.0
     */
