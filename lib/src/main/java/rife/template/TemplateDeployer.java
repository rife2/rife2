...
public class TemplateDeployer {
    ...
    public static void main(String[] arguments) {
                ...
                if (arguments[i].startsWith("-")) {
                    if (arguments[i].equals("-t")) {
                        ...
                        if (arguments[i].startsWith("-")) {
                            ...
                            RifeConfig.instance().template.generationPath(arguments[i]);
                        }
                        ...
                        if (arguments[i].startsWith("-")) {
                            ...
                            RifeConfig.instance().template.defaultEncoding(arguments[i]);
                        }
        ...
        RifeConfig.instance().template.generateClasses(true);
