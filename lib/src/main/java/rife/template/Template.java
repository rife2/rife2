...
public interface Template extends Cloneable {
     ...
     * <p>Value renderer tags are evaluated automatically when the content is
     * generated. You can manually call this method to force evaluation of the tags at
     * any time.
     *
     * @return the list of names of the template values that were generated
     ...
     *
     * @param valueId the value ID to register as generated values
     * @see #isValueGenerated
     * @since 1.5
     */
    void addGeneratedValue(String valueId);
