...
public class Validation<B extends ConstrainedBean, P extends ConstrainedProperty> implements ValidatedConstrained<P>, Cloneable, Constrained<B, P>, ConstrainedPropertyListener {
    ...
    private Map<String, P> constrainedProperties_ = null;
    private Set<String> activePropertyConstraints_ = null;
    private Map<String, ValidationGroup<P>> validationGroups_ = null;
    private B constrainedBean_ = null;
    ...
    public ValidationGroup<P> addGroup(String name) {
        ...
        if (null == validationGroups_) {
            validationGroups_ = new HashMap<String, ValidationGroup<P>>();
        }
    ...
    public void focusGroup(String name) {
        ...
        ValidationGroup<P> group = validationGroups_.get(name);
        if (null == group) {
            return;
        }
...
//        }
    ...
    public List<PropertyValidationRule> addConstrainedPropertyRules(P constrainedProperty) {
        ...
        if (null == constrainedProperties_) {
            constrainedProperties_ = new LinkedHashMap<String, P>();
        }

        // store the constrained property and obtain the old one if it exists
        P old_constrained_property = constrainedProperties_.put(constrainedProperty.getPropertyName(), constrainedProperty);
    ...
    throws CloneNotSupportedException {
        ...
        try {
            ...
            if (constrainedProperties_ != null) {
                new_validation.constrainedProperties_ = new LinkedHashMap<String, P>();
                for (Map.Entry<String, P> entry_property : constrainedProperties_.entrySet()) {
            ...
            if (validationGroups_ != null) {
                new_validation.validationGroups_ = new HashMap<String, ValidationGroup<P>>();
                ValidationGroup<P> new_group;
                for (ValidationGroup<P> group : validationGroups_.values()) {
